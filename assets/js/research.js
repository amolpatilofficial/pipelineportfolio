...
const research = [
    {
        title : "Embodiment Well RescueIntelligent Device With Real-Time Feed for  safety Lift",
        authors : "AUTHORS - Amol Patil , Saurav saidane , Aniket Shinde ",
        conferences : "AEGAEUM JOURNAL _UGC CareApproved Group II Journal Vol 8 Issue 04,2020",
        researchYr : 2020,
        citebox : "popup1",
        image : "https://ik.imagekit.io/amolpatilofficial/Certificates/AGM-J-2686-3_--30R9Daj.jpg",
        citation: {
            vancouver: "AEGAEUM JOURNAL _UGC CareApproved Group II Journal Vol 8 Issue 04,2020 SERIAL NO -13, ISSN: 0776-3808"
        },
        abstract: "",
        absbox: "absPopup1"
    },
            ...
            <tr> 
                ...
                <td class = "researchTitleName">
                    ...
                    <div class="d-flex" style="margin-right:5%;">
                        <button class="button button-accent button-small text-right button-abstract " type="button" data-toggle="collapse" href= "https://ik.imagekit.io/amolpatilofficial/Certificates/AGM-J-2686-3_--30R9Daj.jpg" data-target="#${absbox}" aria-expanded="false" aria-controls="${absbox}">
                            ABSTRACT
                        </button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
